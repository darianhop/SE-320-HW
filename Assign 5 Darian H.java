/* Darian D. Hopkins
 * Software Construction Homework 5
*/
public class Day
 {
	...
	public static void main(String[] args) {
		...
		Day today = new Day(2022, 11, 28);
		Day birthday = new Day(1993, 1, 13);
		int timeDist = today.daysFrom(birthday);
		//daysFrom(birthday);
		System.out.println("The amount of days between my birthday (Jan, 13, 1993) \n and today"
				+ "(Nov, 28th, 2022) is  "+timeDist);
